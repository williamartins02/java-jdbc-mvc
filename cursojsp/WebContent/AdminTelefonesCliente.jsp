					...
					<div class="col-md-20 col-sm-12 ">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div class="col-md-6">
									<h3>Cadastro telefone cliente</h3>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 ">
									<div class="x_panel">
										<div class="x_title">
											...
											<h2>
												Form <small>telefone cliente</small>
											</h2>
										...
										<div class="x_content">
											...
											<form action="salvarTelefoneCliente" method="post"
												id="formUser">
												...
												<div class="row">
													...
													<div class="col-md-1 col-sm-6">
														<input type="text" class="form-control has-feedback-left"
															...
															value="${userCliente.id}" readonly="readonly"> <span
															class="fa fa-asterisk form-control-feedback left"
															aria-describedby="emailHelp"></span>
													</div>


													<label for="inputEmail4" class="form-label">Nome
														cliente:</label>
													<div class="col-md-4 ">
														<input type="text" class="form-control has-feedback-left"
															readonly="readonly" id="nome" name="nome"
															value="${userCliente.nome}"> <span
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 ">
											<div class="x_panel">
												<div class="x_title">
													<h2>
														Lista <small>Telefone cliente</small>
													</h2>
													<ul class="nav navbar-right panel_toolbox">
														<li><a class="collapse-link"><i
														...
														<div class="col-sm-12">
															<div class="card-box table-responsive">
																...
																<table id="datatable"
																	...
																	<tbody>
																		<c:forEach items="${telefone}" var="tel">
																			<tr>

																				<td><c:out value="${tel.id}"></c:out></td>
																				<td><c:out value="${tel.numero}"></c:out></td>
																				<td><c:out value="${tel.tipo}"></c:out></td>


																				<td><a
																					href="salvarTelefoneCliente?&acao=deleteFone&telId=${tel.id}"
																					onclick><img
