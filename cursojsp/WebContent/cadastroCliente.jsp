										...
										<div class="x_content">
											...
											<form action="salvarCliente?acao=salvar" method="post"
												...
												<div class="row">
													...
													<div class="col-md-4 ">
														<input type="text" class="form-control has-feedback-left"
															value="${user.sobrenome}" id="sobrenome" name="sobrenome" maxlength="25"
															placeholder="Digite seu sobrenome"> <span
															class="fa fa-user form-control-feedback left "
															aria-hidden="true"></span>
													</div>
												</div>
		...
		out.print("");
												...
												<div class="row">
													...
													<div class="col-md-4">
														<input type="text" class="form-control has-feedback"
															value="${user.rua}" readonly="readonly" id="rua" name="rua" maxlength="50"
													...
													<div class="col-md-2">
														<input type="text" class="form-control has-feedback"
															value="${user.bairro}" readonly="readonly" id="bairro" name="bairro"
													...
													<div class="col-md-2">
														<input type="text" class="form-control has-feedback"
															value="${user.cidade}" readonly="readonly" id="cidade" name="cidade"
													...
													<div class="col-md-1">
														<input type="text" readonly="readonly" class="form-control has-feedback"
							...
							<form class="form-inline mt-2 mt-md-0 justify-content-end "
								...
								<input class="form-control mr-sm-2" style="width: 25%"
									type="text" id="consultacliente" name="consultacliente"
															...
															<tbody>
																<c:forEach items="${listarCliente}" var="user">
																	<tr>
																		...
																		<td><a
																			href="salvarTelefoneCliente?user=${user.id}"><img
